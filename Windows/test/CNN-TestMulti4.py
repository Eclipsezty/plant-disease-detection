...
my_model = keras.models.load_model("F:/Study/FYP/training/models/Grape3-2_e20+2__100.0.h5")
# my_model2 = keras.models.load_model("F:/Study/FYP/training/models/Grape3-2_e20+2.32+__100.0.h5")
my_model2 = keras.models.load_model("F:/Study/FYP/training/models/Grape3-Eff_e40.h5")
my_model3 = keras.models.load_model("F:/Study/FYP/training/models/Grape3-bi__100.0.h5")
my_model4 = keras.models.load_model("F:/Study/FYP/training/models/Grape3-bi_e20_100.0.h5")
        ...
        if(confidence>80):
            ...
            if (predicted_class == "Grape___Black_rot"):
                ...
                if(confidence>80):
                    ...
                    predicted_class, confidence = predict(my_model4, image)
                    if (predicted_class == "Grape___Black_rot"):
                        countBR += 1
                    elif (predicted_class == "Grape___Esca_(Black_Measles)"):
                        countE += 1
